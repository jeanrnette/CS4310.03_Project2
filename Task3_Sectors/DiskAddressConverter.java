...
public class DiskAddressConverter {
    public static void main(String[] args) {
        ...
        System.out.println("This program converts a logical block " 
        + "number into <cylinder, track, sector> format.\n");
        ...
        // VALIDATING INPUT (before calculations) //////////////////////
        ...
        // OUTPUT //////////////////////////////////////////////////////
            ...
            System.out.println("\nThe logical block number " + block_num 
                + " is located at:\n\t< " + 
                cylinder + " , " + 
                track + " , "  + 
                sector + " >\n");
